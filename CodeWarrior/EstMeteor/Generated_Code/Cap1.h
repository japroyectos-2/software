...
#define Cap1_COUNTER_INPUT_CLOCK_HZ    0x01000000LU /* Initial counter input clock frequency [Hz] */
...
#define Cap1_COUNTER_INPUT_CLOCK_HZ_HIGH 0x01000000LU /* Counter input clock frequency in high speed mode [Hz] */
...
#define Cap1_GetCaptureValue(Value) \
  ...
  (((*(Cap1_TCapturedValue*)(Value) = TPM2C1V), \
