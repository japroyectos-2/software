...
{
  /* TPM3C3SC: CH3F=0,CH3IE=0,MS3B=1,MS3A=1,ELS3B=1,ELS3A=0,??=0,??=0 */
  setReg8(TPM3C3SC, 0x38U);            /* Set up PWM mode with output signal level high */ 
  return ERR_OK;                       /* OK */
}
...
byte PWM4_Disable(void)
{
  ...
  setReg8(TPM3C3SC, 0x00U);            /* Disable output signal */ 
  return ERR_OK;                       /* OK */
}
